		...
		maximisePanelButton= new JButton() {
			...
			public void paint(Graphics g) {
				...
				Image im;
					...
					try {
						im = ImageIO.read(new File("./assets/forward.png")).getScaledInstance(this.getWidth()/2,this.getHeight()/2, java.awt.Image.SCALE_SMOOTH);
			...
			public void paint(Graphics g) {
				...
				Image im;
					...
					try {
						...
						im = ImageIO.read(new File("./assets/search.png")).getScaledInstance(this.getWidth()/2,this.getHeight()/2, java.awt.Image.SCALE_SMOOTH);
						g2.drawImage(im,this.getWidth()/4,this.getWidth()/4, null);
					} catch (IOException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
