...
public abstract class PresElement {
    ...
    protected PresElement(Point pos, int width, int height, float duration, Slide slide) {
        this.pos = pos;
        this.width = width;
        this.height = height;
    ...
    /**
     * Sets the visibility of the component based on the provided boolean value. If the component is set to be displayed
     * and a positive duration is specified, it will automatically hide the component after the specified duration in seconds.
     *
